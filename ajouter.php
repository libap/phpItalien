...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $lundi = isset($_POST['input-ajouter-lundi']) ? 1 : 0;
    $mardi = isset($_POST['input-ajouter-mardi']) ? 1 : 0;
    $mercredi = isset($_POST['input-ajouter-mercredi']) ? 1 : 0;
    $jeudi = isset($_POST['input-ajouter-jeudi']) ? 1 : 0;
    $vendredi = isset($_POST['input-ajouter-vendredi']) ? 1 : 0;
